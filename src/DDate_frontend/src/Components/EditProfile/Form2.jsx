    ...
    return (
        ...
        >
            ...
            <div className="mb-2 grid grid-cols-5 gap-8 ">
                ...
                <div className="flex col-span-3 flex-wrap gap-2 md:gap-2 mb-4 py-2 px-0 rounded-3xl">
            ...
            <div className="flex flex-col md:flex-row md:space-x-4 mb-6">
                ...
                <div className="mb-2 grid grid-cols-5 gap-8 ">
                    ...
                    <div className="flex col-span-3 flex-wrap gap-2 md:gap-2 mb-2 py-2  rounded-3xl">
            ...
            <div className="mb-2 grid grid-cols-5 gap-8 ">
                ...
                <div>
                    <div className="flex col-span-3 flex-wrap gap-2 md:gap-2 mb-2 py-2  rounded-3xl">
                        {["Hindu", "Muslim", "Sikh", "Christian", "Jain", "Catholic", "Agnostic", "Jewish", "Atheist", "Buddhist", "Spiritual"].map((religion) => (
                            <label
                                key={religion}
            ...
            <div className="mb-2 grid grid-cols-5 gap-8 ">
                ...
                <div className="flex col-span-3 flex-wrap gap-2 md:gap-2 mb-2 py-2 px-0 rounded-3xl">
