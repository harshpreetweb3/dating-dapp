...
function ProfileModal2({ profile, onClose }) {
  ...
  <div className="text-white text-[30px] font-dynalight mb-10">It's a Match!</div>
  <div className="flex">
    <div className="bg-white w-[150px] h-[150px] overflow-hidden rounded-full">
      <img src="image1.jpg" alt="Matched Person 1" className="w-full h-full object-cover" />
    </div>
    <div className="bg-white w-[150px] h-[150px] overflow-hidden rounded-full ms-4">
      <img src={profile.images[0]}  alt="Matched Person 2" className="w-full h-full object-cover" />
    </div>
  </div>
